...
import { ChainLinkOracleContract, FarmAuctionContract, LotteryContract, NMDTokenContract, PancakeProfileContract, PredictionsContract } from './types'
...
export const getLotteryContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(LotteryAbi, getLotteryAddress(), signer) as LotteryContract
}